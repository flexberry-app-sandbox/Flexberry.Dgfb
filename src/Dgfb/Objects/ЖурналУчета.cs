...
namespace IIS.Dgfb
{
    ...
    [View("ЖурналУчетаE", new string[] {
            ...
            "ТранспСр.Марка"})]
    [MasterViewDefineAttribute("ЖурналУчетаE", "ТранспСр", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Марка")]
    ...
    public class ЖурналУчета : ICSSoft.STORMNET.DataObject
    {
        ...
        private System.DateTime fВремяВозвращ;
        ...
        /// ВремяВозвращ.
        /// </summary>
        // *** Start programmer edit section *** (ЖурналУчета.ВремяВозвращ CustomAttributes)

        // *** End programmer edit section *** (ЖурналУчета.ВремяВозвращ CustomAttributes)
        public virtual System.DateTime ВремяВозвращ
        {
            get
            {
                // *** Start programmer edit section *** (ЖурналУчета.ВремяВозвращ Get start)

                // *** End programmer edit section *** (ЖурналУчета.ВремяВозвращ Get start)
                System.DateTime result = this.fВремяВозвращ;
                // *** Start programmer edit section *** (ЖурналУчета.ВремяВозвращ Get end)

                // *** End programmer edit section *** (ЖурналУчета.ВремяВозвращ Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (ЖурналУчета.ВремяВозвращ Set start)

                // *** End programmer edit section *** (ЖурналУчета.ВремяВозвращ Set start)
                this.fВремяВозвращ = value;
                // *** Start programmer edit section *** (ЖурналУчета.ВремяВозвращ Set end)

                // *** End programmer edit section *** (ЖурналУчета.ВремяВозвращ Set end)
            }
        }
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЖурналУчетаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЖурналУчетаE", typeof(IIS.Dgfb.ЖурналУчета));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЖурналУчетаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЖурналУчетаL", typeof(IIS.Dgfb.ЖурналУчета));
                }
            }
        }
    }
