...
namespace IIS.Dgfb
{
    ...
    public class Персонал : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Dgfb.Должности fДолжности;
        ...
        [PropertyStorage(new string[] {
                "Должности"})]
        [NotNull()]
        public virtual IIS.Dgfb.Должности Должности
        {
            get
            {
                ...
                IIS.Dgfb.Должности result = this.fДолжности;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПерсоналE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПерсоналE", typeof(IIS.Dgfb.Персонал));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПерсоналL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПерсоналL", typeof(IIS.Dgfb.Персонал));
                }
            }
        }
    }
